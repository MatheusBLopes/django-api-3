...
class CursosViewSet(viewsets.ModelViewSet):
    ...
    # Reescrevemos o create para inserir o cabeçalho Location na requisição
...
class MatriculaViewSet(viewsets.ModelViewSet):
    ...
    # Indica o tempo que o cache irá existir
    @method_decorator(cache_page(20))
    # Indica os dados que devem ser armazenados no cache
